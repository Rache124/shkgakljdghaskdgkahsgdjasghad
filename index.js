...
client.emojiler = {
  gold: "820042243594256451", //?PARAM DAKİ ALTIN EMOJİSİ
  paraGitti: "820042243594256451", // X İŞARETİ
  paraGitmedi: "820042243594256451", // TİK İŞARETİ
  paraROZET: "820042243594256451", // PARA İLE ALINAN YILDIRIM ROZET EMOJİSİ
  onayRozet: "820042243594256451", // ONAY ROZETİ
  modRozet: "820042243594256451", // MOD ROZETİ
  yetkiliRozet: "820042243594256451", // YETKİLİ ROZETİ
  destekçiRozet: "820042243594256451",
  evet: "820042243594256451", // TİK İŞARET
  hayır: "820042243594256451", // X İŞARETİ
  acikk: "820042243594256451",
  kapalii: "820042243594256451",
  kendineParaYollama: "820042243594256451", // KENDİNE PARA ATMAYA ÇALIŞANLAR İÇİN SİNİRLİ EMOJİSİ
  konfeti: "820042243594256451", // MESLEK SAHİBİ OLUNCA RENGARENK KONFETİ ATIYOR
  yukleniyor: "820042243594256451", // YÜKLENİYOR EMOJİ İŞTE :D
  sinirli: "820042243594256451", // TİTREYEN SİNİRLİ :D
  mutlu: "820042243594256451", // MUTLU EMOJİ
  rahatsızetme: "820042243594256451", // RAHATSIZ ETMEYİN EMOJİSİ
  çevrimiçi: "820042243594256451", // ÇEVRİMİÇİ EMOJİSİ
  yayıncı: "820042243594256451", // YAYINCI EMOJİSİ
  çevrimdışı: "820042243594256451", // ÇEVRİM DIŞI EMOJİSİ
  boşta: "820042243594256451", // BOŞTA EMOJİSİ
  bot: "820042243594256451", // BOT EMOJİSİ
  polis: "820042243594256451", // POLİS EMOJİ
  Yvar: "820042243594256451", // YETKİLERİM KOMUDUNDAKİ TİK İŞARETİ
  Yyok: "820042243594256451", // YETKİLERİM KOMUDUNDAKİ X İŞARETİ
  yan: "820042243594256451", // > GİBİ EMOJİ İŞTE :ç
  kalpSarılmalı: "820042243594256451",
  olumlu: "",
  olumsuz: "",

  // AYARLAR KOMUDUNDAKİ AÇIK KAPALI EMOJİLERİ >>>>>>>>>>>>>>>>>
  kapalıA: "820042243594256451",
  açıkA: "820042243594256451",

  // AÇIK BONUS EMOJİLERİ -------------- >>>>>>>>>>

  açıkB: "820042243594256451", // B
  açıkO: "820042243594256451", // O
  açıkN: "820042243594256451", // N
  açıkU: "820042243594256451", // U
  açıkS: "820042243594256451", // S

  // KAPALI BONUS EMOJİLERİ ---------------- >>>>>>>>>>>>>

  kapalıO: "820042243594256451", // O
  kapalıN: "820042243594256451", // N
  kapalıU: "820042243594256451", // U
  kapalıS: "820042243594256451" // S
};

client.ayarlar = {
  oynuyor: "!!yardım",
  official_sahip: "518794343256031234",
  sahip: "518794343256031234",

  yardimcilar: ["310429317140316173"],
  isim: "Aloshia",
  botD:
    "https://discordapp.com/oauth2/authorize?client_id=820038148973133854&scope=bot&permissions=8",
  webS: "https://aware-hurricane-syzygy.glitch.me/",
  web: "https://aware-hurricane-syzygy.glitch.me/",
  site: "https://aware-hurricane-syzygy.glitch.me/",
  dblO: "https://discordbots.org/bot/820038148973133854/vote",
  dbl: "https://discordbots.org/bot/820038148973133854",
  dbltoken:
        "",
  webpanel: "https://aware-hurricane-syzygy.glitch.me/",
  versiyon: "2.0",
  prefix: "!!",
  renk: "RANDOM",
  version: "1.0.0"
...
if (kufures === 2) {
  ...
  if (kufures === 3) {
    msg.client.users.cache.get(msg.author.id).send(`Hey Küfür Sayınız \`3\` e ulaştı. Sunucudan atıldınız.`)
   ...
   if (kufures === 5) {
     ...
     msg.guild.owner.send(`Hey, <@${ads}> Adlı kullanıcının Küfür Sayısı \`5\` e ulaştı. Ve Sunucudan banlandı.`)
         msg.client.users.cache.get(msg.author.id).send(`Hey Küfür Sayınız \`5\` e ulaştı. Sunucudan banlandınız.`)
        msg.guild.member(msg.author.id).members.members.ban(); 
...
client.on("guildMemberAdd", async member => {
  if (db.has(`otoR_${member.guild.id}`) === true) {
    ...
    var rolD = `${
      member.guild.roles.cache.get(db.fetch(`otoR_${member.guild.id}`))
        ? "var"
        : "yok"
    }`;
    ...
    const embed = new Discord.MessageEmbed()
      ...
      .setDescription(
        `<a:mavi:690267134261329950> Gold üye kayboldu. \`${
          ...
          member.guild.members.cache.size}\` Kişi Kaldı <a:mavi:690267134261329950>`
      );
